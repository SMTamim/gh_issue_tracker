...
class IssuesResponse {
  ...
  IssuesResponse({this.items = const []});

  factory IssuesResponse.fromJson(List<dynamic> json) {
    return IssuesResponse(
      items: APIHelper.getSafeListValue(json)
  ...
  static IssuesResponse getAPIResponseObjectSafeValue(
          dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? IssuesResponse.fromJson(unsafeResponseValue as List<dynamic>)
          : IssuesResponse();
}
...
class Issues {
  ...
  factory Issues.fromJson(Map<String, dynamic> json) {
    return Issues(
      ...
      draft: APIHelper.getSafeBoolValue(json['draft']),
      pullRequest:
          PullRequest.getAPIResponseObjectSafeValue(json['pull_request']),
  ...
  factory Issues.empty() => Issues(
        user: User.empty(),
        pullRequest: PullRequest.empty(),
        reactions: Reactions.empty(),
      );

  static Issues getAPIResponseObjectSafeValue(dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? Issues.fromJson(unsafeResponseValue as Map<String, dynamic>)
          : Issues.empty();
}
...
class SingleAssignees {
  bool test;

  SingleAssignees({this.test = false});

  factory SingleAssignees.fromJson(Map<String, dynamic> json) {
    return SingleAssignees(
      test: APIHelper.getSafeBoolValue(json['test']),
    );
  }
  ...
  factory SingleAssignees.empty() => SingleAssignees();

  static SingleAssignees getAPIResponseObjectSafeValue(
          dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? SingleAssignees.fromJson(
              unsafeResponseValue as Map<String, dynamic>)
          : SingleAssignees.empty();
}
...
class PullRequest {
  ...
  factory PullRequest.fromJson(Map<String, dynamic> json) {
    return PullRequest(
      url: APIHelper.getSafeStringValue(json['url']),
      htmlUrl: APIHelper.getSafeStringValue(json['html_url']),
      diffUrl: APIHelper.getSafeStringValue(json['diff_url']),
      patchUrl: APIHelper.getSafeStringValue(json['patch_url']),
  ...
  factory PullRequest.empty() => PullRequest();

  static PullRequest getAPIResponseObjectSafeValue(
          dynamic unsafeResponseValue) =>
      APIHelper.isAPIResponseObjectSafe(unsafeResponseValue)
          ? PullRequest.fromJson(unsafeResponseValue as Map<String, dynamic>)
          : PullRequest.empty();
}
